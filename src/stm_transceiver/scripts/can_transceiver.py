...
k=0
def send_one(bus):
    global thrusterSpeed, rudderAngle, massShifterPosition, pistonPosition, count,k
    ...
    headers = [[79, 76, 82 if (thruster_pwm < 0) else 76], [82, 85, 68], [79, 76, 77], [
        79, 76, 80], [67, 79, 78 if lock else 70], [69, 74, 83], [69, 74, 83]]
...
if __name__ == "__main__":
    ...
    #    'command/set_arming', CommandLong, onSetArmingCallBacks)
    rospy.spin()
